...
The answer options are all the ‘selection from a list’ questions from the form that only allow only one answer (radio questions). In the example in the image, there are 2 questions the form creator can select from. 
