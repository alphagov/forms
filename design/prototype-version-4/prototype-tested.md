...
Dates tested: 2022-06-23 to 2022-06-24

## Status

Superceeded by [version 5](../prototype-version-5)

## Context

> Sprint 6  
> In this sprint we want to test the small changes made off the back of previous rounds of research, including the accessibility round
...
- we removed the question short name
- made the hint text always visible by removing it from the detail component and improved the content to align with this change
- switched the save buttons so the primary one would move the form creator on to create the next question by default unless they wanted to save and preview changes
- save buttons content updated to reflect issues seen in research last round
- changed call to actions layout so that “Delete question” button would appear on new line


For more information, see [v0.0.4 release notes](https://github.com/alphagov/forms-prototypes/releases/tag/v0.0.4).
